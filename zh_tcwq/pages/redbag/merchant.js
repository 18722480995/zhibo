...
Page({
    ...
    refresh: function(e) {
        ...
        console.log(o.data.seller), this.setData({
         ...
         let expiration_time = o.data.seller.dq_time * 1e3
         let time_7 = 604800000
         let timeRemaining = expiration_time - new_time
         if(timeRemaining <= 0 || timeRemaining-time_7 <= 0){
            if(timeRemaining <= 0){
                this.setData({
                    werchat:!0,
                    tips_title:'您的店铺已到期，是否续费'
                })
            }
            if(timeRemaining-time_7 <= 0){
                this.setData({
                    werchat:!0,
                })
            }
