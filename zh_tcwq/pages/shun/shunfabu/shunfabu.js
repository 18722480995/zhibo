...
Page({
  ...
  onLoad: function (t) {
    ...
    var c, o, s, i = (c = new Date(), o = c.getMonth() + 1, s = c.getDate(), 1 <= o && o <= 9 && (o = "0" + o),
      0 <= s && s <= 9 && (s = "0" + s), c.getFullYear() + "-" + o + "-" + s + " " + c.getHours() + ":" + c.getMinutes() + ":" + c.getSeconds()).slice(0, 11),
      l = "";
  ...
  formSubmit: function (t) {
    ...
    var n = wx.getStorageSync("users").id,
      c = e.data.id,
      o = e.data.type_name,
      s = t.detail.value.address1,
      i = t.detail.value.address2,
      l = t.detail.value.path;
    null == l && (l = " ", console.log(l));
    var u = e.data.date + e.data.time,
      d = e.data.array[e.data.arr_index],
      r = t.detail.value.weight,
      g = t.detail.value.contacts,
      p = t.detail.value.contacts_tel,
      f = t.detail.value.other_demand,
      m = Number(e.data.money),
      _ = (o = e.data.type_name,
        e.data.start_lat),
      h = e.data.start_lng,
      y = e.data.end_lat,
      w = e.data.end_lng;
