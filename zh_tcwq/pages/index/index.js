...
Page({
    ...
    onLoad: function(t) {
        ...
        if (console.log("scene", e), "undefined" != e) {
            var a = e;
            wx.setStorageSync('parent_id', a);
            this.setData({
                fxzuid: a
              });
        }
        ...
        app.util.request({
            ...
            cachetime: "30",
            success: function(t) {
                wx.setStorageSync("color", t.data.color), 1e4 < Number(t.data.total_num) && (t.data.total_num = (Number(t.data.total_num) / 1e4).toFixed(2) + "万"), 
                n.setData({
                    System: t.data
                });
            }
    ...
    reload: function(t) {
        var c = this, 
        i = wx.getStorageSync('parent_id');
        console.log(i), 
        console.log(wx.getStorageSync('parent_id'))
        wx.login({
            success: function(t) {
                var e = t.code;
                        ...
                        console.log(t), t.authSetting["scope.userInfo"] ? wx.getUserInfo({
                            success: function(t) {
                                ...
                                app.util.request({
                                    ...
                                    success: function(t) {
                                        console.log(t), wx.setStorageSync("key", t.data.session_key),
