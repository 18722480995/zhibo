...
Page({
  ...
  location: function () {
    var e = this.data.hdinfo.coordinate.split(","),
      t = this.data.hdinfo.address;
  ...
  onLoad: function (e) {
    ...
    console.log(e);
    var t = this,
      o = util.formatTime(new Date()).replace(/\//g, "-").toString();
    console.log(o);
  ...
  formSubmit: function (e) {
    ...
    var t = this,
      ...
      n = e.detail.formId,
      i = t.data.hdinfo.id,
      s = this.data.hdinfo.money,
      c = e.detail.value.lxr,
      l = e.detail.value.tel;
    ...
    "" == c ? d = "请填写联系人！" : "" == l || l.length < 11 ? d = "请填写正确联系电话！" : (r = !1,
      t.setData({
        ...
        success: function (e) {
          console.log(e), "人数已满" != e.data && "报名失败" != e.data ? 0 < s ? 
          app.util.request({
