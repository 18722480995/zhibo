...
Page({
    ...
    onShareAppMessage: function() {
        ...
        return {
            ...
            path: "/zh_tcwq/pages/collage/group?user_id=" + o.options.user_id + "&goods_id=" + o.options.goods_id + "&id=" + o.options.id,
            success: function(o) {
                console.log(o);
            },
            complete: function(o) {
  ...
  onShareTimeline: function () {
    ...
    return {
      title: wx.getStorageSync("users").name + "邀请您一起来拼团",
      query: "user_id=" + o.options.user_id + "&goods_id=" + o.options.goods_id + "&id=" + o.options.id,
      success: function (o) {
        console.log(o);
      },
      complete: function (o) {
