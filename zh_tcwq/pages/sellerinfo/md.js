...
Page({
  ...
  scrolltxt: function() {
    var e = this,
      o = e.data.length,
      s = e.data.windowWidth,
      n = setInterval(function() {
        var t = o + s,
          a = e.data.marqueeDistance;
        a < t ? e.setData({
  ...
  qrmd: function(t) {
    var e = Number(this.data.total),
      a = wx.getStorageSync("users").id,
      o = this.data.mdinfo.id,
  ...
  onLoad: function(t) {
    ...
    console.log(s), o.lqyhq(s, e), app.util.request({
      ...
      success: function(t) {
        if (console.log("用户信息", t.data), null != t.data.discount) var a = t.data.discount;
        else a = 100;
        o.setData({
          userInfo: t.data,
          discount: a,
      ...
      success: function(t) {
        ...
        var a = t.data.store[0].details.length * o.data.size,
