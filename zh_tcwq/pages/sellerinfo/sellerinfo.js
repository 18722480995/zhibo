...
Page({
          ...
          success: function(t) {
            console.log(t), t.authSetting["scope.userInfo"] ? wx.getUserInfo({
              success: function(t) {
                ...
                var s = t.userInfo.nickName,
                  i = t.userInfo.avatarUrl;
                n.setData({
                    user_name: s
  ...
  Demonstration: function(t) {
    "" != this.data.store.vr_link && wx.navigateToMiniProgram({
      // url: "../car/car?sjid=" + this.data.id,
      appId:this.data.store.vr_link,
      success: function(t) {},
      fail: function(t) {},
      complete: function(t) {}
    });
  ...
  onLoad: function(t) {
    ...
    if(t.tiao === 'true'){
      wx.navigateTo({
        url: "good_info?id=" + t.id_x + "&store_id=" + t.store_id + "&logo=" + t.logo,
        success: function(t) {},
        fail: function(t) {},
        complete: function(t) {}
      });
    ...
    if (app.getUrl(this), null == t.scene) {
      if (wx.getStorageSync("users")) var a = wx.getStorageSync("users"),
  ...
  reload: function(t) {
    ...
    app.util.request({
      ...
      success: function(t) {
        ...
        var a = Number(t.data.store[0].score),
          o = "../image/xing.png";
        0 == (a = parseInt(a)) ? t.data.star3 = d.data.star1 : 1 == a ? t.data.star3[0].img = o : 2 == a ? (t.data.star3[0].img = o,
        ...
        var s = t.data.store[0],
          i = d.data.url;
        console.log(i), console.log(d.data.bath);
        var n = i + s.logo;
        if ("" == s.ewm_logo || null == s.ewm_logo) var r = d.data.bath;
        else r = i + s.ewm_logo;
        ...
        var c = t.data.store[0].details.length * d.data.size,
          u = wx.getSystemInfoSync().windowWidth;
        console.log(c, u), d.setData({
          length: c,
          windowWidth: u
        });
      }
  ...
  formid_two: function(t) {
    ...
    var e = this,
      ...
      n = e.data.reflex_id;
    var r, c, u, d = (r = new Date(), c = r.getMonth() + 1, u = r.getDate(), 1 <= c && c <= 9 && (c = "0" + c),
      0 <= u && u <= 9 && (u = "0" + u), r.getFullYear() + "-" + c + "-" + u + " " + r.getHours() + ":" + r.getMinutes() + ":" + r.getSeconds());
        ...
        app.util.request({
          ...
          success: function(t) {
            ...
            for (var s in t.data) t.data[s].hours = t.data[s].time.slice(10, 19), t.data[s].time = (t.data[s].time,
              ...
              d <= t.data[s].time ? o.push(t.data[s]) : app.util.request({
  ...
  onReady: function() {},
  ctx: function(t) {console.log(t)
    var e = this,
      a = e.data,
      o = (a.width, a.height, wx.createCanvasContext("ctx"));
  ...
  scrolltxt: function() {
    var a = this,
      o = a.data.length,
      s = a.data.windowWidth;
    interval = setInterval(function() {
      console.log("interval");
      var t = o + s,
        e = a.data.marqueeDistance;
      e < t ? a.setData({
  ...
  onShareAppMessage: function() {
    var e = this,
      ...
      a = e.data.store.store_name,
      o = e.data.store.id;
      console.log(t,a,o,'分享群')
    return {
      title: a,
